...
Introduction:
Robinhood: An E-commerce Platform for Feminine Hygiene Products
...
2. Clone the github repositary
3. Run cd frontend in terminal for frontend and type npm run dev to run the forntend code
4. Run npm run dev directly inorder to run the backend
...
<p>1.Understand the mission: Read the README to align your contributions with Robinhood's philosophy.</p>
<p>2.Consistency in programming: Ensure that your proposed changes match the technologies used in the project.</p>
<p>3.Documentation: Include a detailed explanation of the problem you’ve noticed, the proposed solution, and its benefits.</p>
<p>4.Submit pull requests following Git etiquettes: For guidance, refer to Git Etiquettes.</p>
